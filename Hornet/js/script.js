...
document.querySelector('.toggle-btn').addEventListener('click', function() {
 ...
 document.querySelector('.toggle-btn').addEventListener('click', function() {
   const arrowPanel = document.querySelector('.name-1');
   if (arrowPanel) {
     arrowPanel.classList.add('name-1-move');
     this.disabled = true; 
   }
 });

 document.querySelector('.toggle-btn').addEventListener('click', function() {
   const arrowPanel = document.querySelector('.name-2');
   if (arrowPanel) {
     arrowPanel.classList.add('name-2-move');
     this.disabled = true; 
   }
 });
